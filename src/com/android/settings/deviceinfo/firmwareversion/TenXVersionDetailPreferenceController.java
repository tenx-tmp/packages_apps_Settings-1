...
public class TenXVersionDetailPreferenceController extends BasePreferenceController {

    private static final String TAG = "TenXVersionDialogCtrl";
    ...
    public TenXVersionDetailPreferenceController(Context context, String key) {
        super(context, key);
